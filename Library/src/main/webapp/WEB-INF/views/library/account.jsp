...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-12">
				<ul class="nav nav-pills nav-stacked col-md-2">
					...
					<li class="active"><a href="#tab_a" data-toggle="pill">
							<p align="center">
								<i class="fa fa-book fa-5x"> </i> <span style="font-size: 200%;">
									<br>Bookshelf
								</span>
							</p>
					</a></li>
					<li><a href="#tab_b" data-toggle="pill">
							<p align="center">
								<i class="fa fa-tasks fa-4x"> </i> <span
									style="font-size: 200%;"> <br>Lists
								</span>
							</p>
					</a></li>
					<li><a href="#tab_c" data-toggle="pill">
							<p align="center">
								<i class="fa fa-pause fa-4x"> </i> <span
									style="font-size: 200%;"> <br>Holds
								</span>
							</p>
					</a></li>
				...
				<div class="container">
					...
					<div class="tab-content col-md-10">
						<div class="tab-pane active" id="tab_a">
							...
							<div class="container">
								<h1 style="text-align: center;" class="page-header">Bookshelf</h1>

								<!--  <ul>
									<c:forEach items="${dummyBoox}" var="element">								
										...
										<div
											...
											<div align="center">
												<input id="input-21b" value="0" type="number" class="rating"
													min=0 max=5 step=0.5 data-size="xs" data-symbol='&#xF379' 
													data-default-caption='{rating} helmets' data-star-captions="{}">
								...
								<div id="accordion" class="panel-group">
												...
												<div class="container">
													...
													<div class="row row-centered">
														...
														<div class="col-md-3 col-md-offset-2 col-centered portfolio-item">
															...
															<div align="center">
																<input id="input-21b" value="0" type="number"
									...
									<div class="panel panel-primary">
										<div data-toggle="collapse" data-target="#collapseTwo"
											...
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion"
													href="#collapseTwo">Rated Titles</a>
											</h4>
										</div>
										<div id="collapseTwo" class="panel-collapse collapse">
											<div class="panel-body">

												<div class="alert alert-info" role="alert">You haven't
													rated any titles yet.</div>
									...
									<div class="panel panel-primary">
										<div data-toggle="collapse" data-target="#collapseThree"
											...
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion"
													href="#collapseThree">Recommended for you</a>
											</h4>
										</div>
										<div id="collapseThree" class="panel-collapse collapse">
											<div class="panel-body">

												<div class="alert alert-info" role="alert">No titles
													recommended for you, start rating books!</div>
									...
									<div class="panel panel-primary">
										<div data-toggle="collapse" data-target="#collapseFour"
											...
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion"
													href="#collapseFour">Titles you recommend</a>
											</h4>
										</div>
										<div id="collapseFour" class="panel-collapse collapse">
											<div class="panel-body">

												<div class="alert alert-info" role="alert">Titles you
													have recommended will show up here.</div>
								...
								<form class="form-horizontal">
									<fieldset>
										...
										<div class="form-group">
											...
											<label class="col-md-4 control-label" for="LibraryCardNumber">Library
												Card Number:</label>
											<div class="col-md-4">
												<input id="LibraryCardNumber" name="LibraryCardNumber"
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input id="Username" name="Username" type="text"
													placeholder="Ex: baconman4" class="form-control input-md"
													disabled="disabled">
										...
										<div align="center" class="form-group">
											...
											<a class="btn btn-info" role="button"
												...
												data-target="#settings-modal">Edit Settings</a>
											<!--</p>-->
										</div>
			...
			<!--<div id="page-wrapper">-->
			<div id="settings-modal" class="modal fade settings-modal"
				tabindex="-1" role="dialog"
				aria-labelledby="bootstrapLargeModalLabel" aria-hidden="true">
								...
								<fieldset>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label"
											for="libraryCardNumberInput">Library Card Number: </label>
										<div class="col-sm-9">
											<input id="libraryCardNumberInput"
												name="libraryCardNumberInput" type="number"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input id="userNameInput" name="userNameInput" type="text"
												placeholder="SampleUsername" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="passwordInput">Password:
										</label>
										<div class="col-sm-9">

											<input id="passwordInput" name="passwordInput"
												type="password" placeholder="samplePassword"
												class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label"
											for="passwordConfirmInput">Confirm Password: </label>
										<div class="col-sm-9">
											<input id="passwordConfirmInput" name="passwordConfirmInput"
												type="password" placeholder="samplePassword"
												class="form-control" data-match="#passwordInput"
