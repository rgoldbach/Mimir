	...
	<div class="modal-dialog" id="bookModalDialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 id = "bookModalAuthor">
					by
					<span
						id = "bookModalFormat" style="float: right"> Available Formats: 
					</span>
				</h5>
				<!-- Author -->
				<h5>
			...
			<div class="modal-body">
				<input id="currentBook" type="hidden" value="">
				<input id="borrowedBookFormat" type="hidden" value="EBook">
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
						<!-- Portfolio Item Row -->
						<div class="row">
							<div id="bookModalImage" class="col-md-6">
		...
		<div class="modal-content">
			<form id="registerForm" class="form-horizontal"
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="registerModalLabel">Register
						Account</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input id="libraryCardNumberReg" type="text" class="form-control"
								name="libraryCardNumber" placeholder="123456789"
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input id="firstNameReg" type="text" class="form-control"
								name="firstName" placeholder="William" data-bv-notempty="true"
				...
				<div class="modal-footer">
					<button id="register" onclick="registerUser()" name="register"
...
<div class="modal fade" id="advancedSearchModal" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
				...
				<form class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input id="authorCreatorInput" name="authorCreatorInput"
									type="text" placeholder="Author..." class="form-control">
							</div>
						</div>

						<!-- Select Basic -->
						<div class="form-group">
							<label class="col-sm-2 control-label" for="dateAddedSelect">
								Added:</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select id="awardSelect" name="awardSelect" class="form-control">
									<option>These should be</option>
									<option>Filled Out Dynamically</option>
									<option>Selecting The Different</option>
			...
			<div class="modal-footer">
				<a href="search?type=Advanced" type="button" class="btn btn-primary"><span
